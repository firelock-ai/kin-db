...
- Recovery focuses on atomic writes, explicit recovery markers for interrupted snapshot saves, promotion only for marker-proven `graph.tmp` candidates, and rebuild workflows; old snapshots are not retained automatically
